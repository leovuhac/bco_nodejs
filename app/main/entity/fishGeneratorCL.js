...
var FIX_PERCENT_TIEN_CA_CAP1= 1;
var FIX_PERCENT_TIEN_CA_CAP2 = 1;
var FIX_PERCENT_TIEN_CA_CAP3 = 1;
var FIX_PERCENT_CA_VOI = 1;
var FIX_PERCENT_TIEN_CA_CAP4 = 1;
var FIX_PERCENT_CA_THAN_TAI = 0;

var FIX_PERCENT_CA_NEMO = 15;
var FIX_PERCENT_CA_NOC = 13;
var FIX_PERCENT_SUA_BIEN = 11;
var FIX_PERCENT_CA_CHUON = 9;
var FIX_PERCENT_CA_ANGLER = 9;
...
prot.generateFish = function(inputData) {
    ...
    if (delatPercent > 0) {
        ...
        if (lvFishBonus < 2) {
            ...
            // Neu chia van ko het
            percentFish[FIX_PERCENT_TIEN_CA_CAP1 - 1] += delatPercent;
        }
    }
